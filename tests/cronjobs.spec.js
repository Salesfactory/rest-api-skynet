const { computeAndStoreMetrics } = require('../src/cronjobs');
const { getBigquerySpending } = require('../src/utils/bq_spend');

jest.mock('../src/utils/bq_spend', () => ({
    ...jest.requireActual('../src/utils/bq_spend'),
    getBigquerySpending: jest.fn(),
}));
...
describe('computeAndStoreMetrics', () => {
    ...
    it('Validate computeAndStoreMetrics function for a campaign group with bigquery ids', async () => {
        ...
        getBigquerySpending.mockResolvedValue([
            [{ _date: '2023-09-01', spend: 0 }],
        ]);
